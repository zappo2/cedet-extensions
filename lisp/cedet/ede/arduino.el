...
;;
;; Copyright (C) 2012, 2013, 2014, 2015, 2016, 2017, 2021 Eric M. Ludlam
;;
...
(defun ede-arduino-read-prefs (prefsfile)
  ...
  (let* ((buff (get-file-buffer prefsfile))
	...
	(setq _board (buffer-substring-no-properties (point) (point-at-eol)))
	(oset ede-arduino-active-prefs board _board)
	...
	(oset ede-arduino-active-prefs sketchbook
      ...
      (oset ede-arduino-active-prefs boardobj (ede-arduino-board-data _board))
